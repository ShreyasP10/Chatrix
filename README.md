...
- **Activity rings & lurker detection** — member avatars show recency-based rings; "observer" tag for members who never spoke; activity timeline ("Active 2m ago")
...
- `rooms/{code}/members/{uid}` — `lastSpokeAt` (lurker detection)
